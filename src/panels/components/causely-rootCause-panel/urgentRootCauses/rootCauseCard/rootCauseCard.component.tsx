...
export const RootCauseCard = ({ rootCause }: RootCauseCardProps) => {
  ...
  const styles = useStyles2(getRootCauseCardStyles);
    ...
    >
      ...
      <CUISection>
        ...
        <CUISectionDescription>
          <CUIText variant="secondary">{DefectsUtil.defectOnEntityDescription(rootCause)}</CUIText>
        </CUISectionDescription>
      </CUISection>
      ...
      <CUISection>
        ...
        <CUISectionDescription>
          <CUIText variant="secondary">{symptomDescriptions.masterSentence}</CUIText>
        </CUISectionDescription>
        <CUISectionDescription>
          <CUIText variant="secondary">{symptomDescriptions.secondarySentence}</CUIText>
        </CUISectionDescription>
      </CUISection>
      ...
      <CUISection>
        ...
        <CUISectionDescription>
          <CUIText variant="secondary">{TimeUtil.formatDate(rootCause.fromTime)}</CUIText>
        </CUISectionDescription>
      </CUISection>
      ...
      <CUISection>
        ...
        <CUISectionDescription>
          <CUIText variant="secondary">{getEvidenceList(evidence, rootCause)}</CUIText>
        </CUISectionDescription>
      </CUISection>
    </div>
  );
